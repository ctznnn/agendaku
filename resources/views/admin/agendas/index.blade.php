...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.agendas.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition shadow-sm">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <span class="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        Centang agenda yang ingin di-share
                    </span>
                </div>
                <div class="flex gap-2">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                $statusColors = [
                                    'direncanakan' => 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400',
                                    'berlangsung' => 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
                                    'selesai' => 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400',
                                    'batal' => 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'
                                ];
                                $statusText = [
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <a href="{{ route('admin.agendas.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg">
                                    <i class="fas fa-plus mr-2"></i>
                                    Tambah agenda baru
                                </a>
                            </div>
...
// DESELECT ALL - Tombol Hapus Pilih
